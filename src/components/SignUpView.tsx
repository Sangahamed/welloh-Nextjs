...
const SignUpView: React.FC<SignUpViewProps> = ({ onNavigate }) => {
  ...
  if (isSignedUp) {
    return (
      <AuthLayout title="Bienvenue dans l'élite !">
  ...
  return (
    <AuthLayout title="Rejoignez Welloh">
      ...
      <div className="space-y-3">
        <SocialButton icon={<GoogleIcon className="w-5 h-5" />} providerName="Google" />
        <SocialButton icon={<AppleIcon className="w-5 h-5" />} providerName="Apple" />
      </div>
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <div className="space-y-4">
          ...
          <div className="flex flex-wrap gap-4 pt-2">
            <PasswordRequirement meets={isPasswordLongEnough} text="6+ caractères" />
